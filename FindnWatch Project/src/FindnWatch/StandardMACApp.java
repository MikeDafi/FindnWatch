...
//	static final String appName = "FindnWatch";
...
//	    quitCommand.addEventHandler(eventType, eventHandler);
//	    quitCommand.addEventHandler(new ActionListener() {
//	        @Override
...
//	    });  
//	    
//	    MenuItem toFullScreenCommand = new MenuItem("Switch In/Out FullScreen(Alt + Shift + A)");
...
//	    }); 
//	    
//	    MenuItem nextBiggestCommand = new MenuItem("Next Biggest Space(Alt + Shift + F)");
//	    reScanAndRefitCommand.addActionListener(new ActionListener() {
//	        @Override
//	        public void actionPerformed(ActionEvent e) {
//	        	nextBiggest();
...
//		
//		
//		MenuItem prefsItem = new MenuItem("Commands");
